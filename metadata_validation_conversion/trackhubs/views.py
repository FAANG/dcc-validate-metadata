...
def register_trackhub(request):
    if request.method == 'POST':
        ...
        hub_url = f"https://data.faang.org/api/data/fire_api/trackhubregistry/{hub_dir}/hub.txt"
        ...
        trackdb_url = f"https://data.faang.org/api/data/fire_api/trackhubregistry/{hub_dir}/{genome_name}/trackDB.txt"
        ...
        for id in biosample_ids:
            update_url = f"https://data.faang.org/api/data/specimen/{id}/update"
